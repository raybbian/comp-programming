...
int main() {
	...
	cin >> k;
	if (k == 1) {
		cout << "Alas! Farha is bitten by snake. She is now at " << 75 << "." << ln;
	} else if (k == 2 || k == 3) {
		cout << "Nothing happened to her." << ln;
	} else if (k == 4) {
		cout << "Alas! Farha is bitten by snake. She is now at " << 79 << "." << ln;
	} else if (k == 5) {
		cout << "Farha is on ladder." << ln;
	} else {
		cout << "Yay! Farha has won the game. She is now at 100." << ln;
	}
}