...
void solve() {
  ...
  // trains line up
  // put into first stack
  // if current train is greater than first stack back, put move all into second
  // until it is not, and then put current train in first, then put all in
  // second back in first
  vector<int> tmp1, tmp2;
  for (auto &i : st) {
    while (!tmp1.empty() && i > tmp1.back()) {
