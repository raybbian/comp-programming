...
void solve() {
  ...
  cin >> v_k >> j_k >> v_l >> j_l >> v_h >> d_h >> j_h;
  long long l_chain_possible = v_l * j_l;
  long long k_chain_possible = v_k * j_k;
  long long heavy_chain_possible = v_h * d_h * j_h;
  cout << (l_chain_possible + k_chain_possible) * heavy_chain_possible << ln;
}
